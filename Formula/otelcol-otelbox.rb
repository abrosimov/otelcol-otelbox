...
class OtelcolOtelbox < Formula
  ...
  url "https://github.com/abrosimov/otelcol-otelbox/releases/download/v2.4.0/otelcol-otelbox_darwin_arm64"
  ...
  sha256 "f44d33885f5eda5bb92d7ce7e015f7f6f01c1620cc4fea4bdd53e6a6698535cd"
  ...
  resource "config" do
    url "https://github.com/abrosimov/otelcol-otelbox/releases/download/v2.4.0/otelcol-otelbox_config.tar.gz"

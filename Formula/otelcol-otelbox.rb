...
class OtelcolOtelbox < Formula
  ...
  url "https://github.com/abrosimov/otelcol-otelbox/releases/download/v2.1.2/otelcol-otelbox_darwin_arm64"
  ...
  sha256 "190255190441b000073bee11c4480b836894efa41ef97f90961291f56f6fe24a"
  ...
  resource "config" do
    url "https://github.com/abrosimov/otelcol-otelbox/releases/download/v2.1.2/otelcol-otelbox_config.tar.gz"
